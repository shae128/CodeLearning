...
+ Note that ~write()~ arguments *has to be string*
...
the nested block were to contain a ~return~ statement, or a ~continue~
or ~break~ statement, the with statement would automatically close the
